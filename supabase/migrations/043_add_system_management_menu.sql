...
BEGIN
    ...
    INSERT INTO admin_menu_items (
        ...
        'Settings',
        'Manage users, roles, permissions, and menu configuration',
        'إدارة المستخدمين والأدوار والصلاحيات وإعدادات القائمة',
        max_sort_order + 1,
    ...
    IF system_mgmt_parent_id IS NOT NULL THEN
        ...
        INSERT INTO admin_menu_items (
            ...
            'Menu Access',
            'الوصول إلى القائمة',
            '/admin/system-management/menu-access',
            'Menu',
