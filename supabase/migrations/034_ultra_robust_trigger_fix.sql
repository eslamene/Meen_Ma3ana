-- =====================================================
-- ULTRA-ROBUST TRIGGER FIX
-- =====================================================
-- This version wraps EVERYTHING in exception handling
-- to ensure user creation NEVER fails due to trigger errors
...
BEGIN
    ...
    ELSE
        RAISE NOTICE '❌ Function not found after update';
    END IF;
END $$;

-- Show current function definition (first 500 chars)
SELECT 
