...
import CasePerformanceReport from '../components/CasePerformanceReport'

export default function CasePerformanceReportPage() {
  const t = useTranslations('admin.reports')
  const { containerVariant } = useLayout()

  return (
    <ProtectedRoute>
      <PermissionGuard permission="reports:cases">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm sm:text-base text-gray-600">
                      Detailed case performance metrics and contribution statistics
                    </p>
                  </div>
                </div>
              </div>
