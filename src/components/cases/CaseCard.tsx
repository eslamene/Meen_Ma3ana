  ...
  const GridView = () => {
    ...
    >
      ...
      <CardHeader className="pb-3 relative pt-4">
        ...
        <div className="text-gray-600 text-sm leading-relaxed line-clamp-1" dir={descriptionDir}>
          {displayDescription}
        </div>
      </CardHeader>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between mb-2">
              <div className="flex-1 min-w-0">
                ...
                <div className="text-sm text-gray-600 line-clamp-1 mt-1" dir={descriptionDir}>
                  {displayDescription}
                </div>
              </div>
            </div>
