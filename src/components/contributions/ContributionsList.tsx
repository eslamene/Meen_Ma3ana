          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3 mb-3">
                <div
                  ...
                  className="font-semibold text-base text-gray-900 truncate hover:text-blue-600 transition-colors cursor-pointer"
                >
                ...
                <div className="flex items-center gap-2">
                  ...
                  {isHighlighted && (
                    <Badge variant="outline" className="text-xs bg-blue-500 text-white border-blue-500 font-semibold animate-pulse px-2 py-1">
                      From Notification
                    </Badge>
                  )}
                  {contribution.anonymous && (
                    <Badge variant="outline" className="text-xs bg-gray-100 text-gray-700 border-gray-200 px-2 py-1">
                      Anonymous
                    </Badge>
                  )}
                  {isNested && (
                  ...
                  {isParent && (
                    <Badge variant="outline" className="text-xs bg-red-500 text-white border-red-500 font-semibold px-2 py-1">
                ...
                <div className="flex items-center gap-4 text-sm text-gray-600">
                  ...
                  {(contribution.message || (contribution.notes && contribution.notes.startsWith('REVISION:')) || 
                    ...
                    <button
                      ...
                      className="text-gray-500 hover:text-gray-700 transition-colors flex items-center gap-1 text-xs ml-4"
                    >
                      {isExpanded ? (
                        <>
                ...
                <div className="mt-3 pt-3 border-t border-gray-100">
                  ...
                  <div className="flex items-center gap-3 text-xs text-gray-500 mb-2">
                    <span className="flex items-center gap-1">
                      ...
                      <span className="font-mono text-gray-600">{truncateId(contribution.id)}</span>
                      <div
                    ...
                    {isAdmin && contribution.donorEmail && (
                      <span className="flex items-center gap-1">
                        ...
                        <span className="font-mono text-gray-600">{contribution.donorEmail}</span>
                      </span>
                    )}
                  </div>
            ...
            <div className="relative flex items-center gap-1 flex-shrink-0">
              <div
                ...
                className="h-8 w-8 p-0 rounded-lg border border-gray-200 hover:border-blue-500 hover:bg-blue-50 cursor-pointer inline-flex items-center justify-center transition-all duration-200 hover:shadow-sm"
              >
                <Info className="h-4 w-4 text-gray-600 hover:text-blue-600" />
              </div>
              {contribution.proofUrl && (
                <div
                  title="View proof"
                  onClick={() => onViewProof(contribution)}
                  className="h-8 w-8 p-0 rounded-lg border border-gray-200 hover:border-green-500 hover:bg-green-50 cursor-pointer inline-flex items-center justify-center transition-all duration-200 hover:shadow-sm"
                >
                  <Eye className="h-4 w-4 text-gray-600 hover:text-green-600" />
                </div>
              )}
              {isAdmin && contribution.status === 'pending' && onStatusUpdate && (
                <>
                  <div
                    ...
                    className="h-8 w-8 p-0 rounded-lg border border-green-200 text-green-600 hover:bg-green-50 cursor-pointer inline-flex items-center justify-center transition-all duration-200 hover:shadow-sm"
                  >
                  ...
                  <div
                    ...
                    className="h-8 w-8 p-0 rounded-lg border border-red-200 text-red-600 hover:bg-red-50 cursor-pointer inline-flex items-center justify-center transition-all duration-200 hover:shadow-sm"
                  >
                    <X className="h-4 w-4" />
                  </div>
                </>
              ...
              <div
                ...
                className="h-8 w-8 p-0 rounded-lg border border-gray-200 hover:border-gray-400 cursor-pointer inline-flex items-center justify-center transition-all duration-200 hover:shadow-sm"
                title="More actions"
              >
              ...
              {openMenuForId === contribution.id && (
                <div className="absolute right-0 top-10 z-[70] w-44 rounded-md border border-gray-200 bg-white shadow-lg">
                  ...
                  >
                    <ExternalLink className="h-4 w-4 mr-2 inline-block" /> View Details
                  </div>
                  {contribution.proofUrl && (
                    <div
                      className="w-full px-3 py-2 text-left text-sm hover:bg-gray-50 cursor-pointer"
                    ...
                    >
                      <Eye className="h-4 w-4 mr-2 inline-block" /> View Proof
                    </div>
                  )}
                  {isAdmin && contribution.status === 'pending' && onStatusUpdate && (
                    <>
                      <div
                        className="w-full px-3 py-2 text-left text-sm text-green-600 hover:bg-green-50 cursor-pointer"
                        onClick={() => { setOpenMenuForId(null); onStatusUpdate(contribution.id, 'approved'); }}
                      >
                        <Check className="h-4 w-4 mr-2 inline-block" /> Approve
                      </div>
                      <div
                      ...
                      >
                        <X className="h-4 w-4 mr-2 inline-block" /> Reject
                      </div>
                    </>
                  )}
                </div>
  ...
  return (
    <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
      ...
      <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-200">
        ...
        <span className="text-sm font-medium text-gray-700">Transaction Thread</span>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`flex items-center gap-2 h-9 rounded-md px-3 border border-gray-200 bg-white hover:bg-gray-50 text-sm font-medium ${
            ...
            >
              <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                ...
                <div className="flex items-center gap-2 mb-3 pb-2 border-b border-gray-200">
                  ...
                  <span className="text-sm font-medium text-gray-700">Single Contribution</span>
